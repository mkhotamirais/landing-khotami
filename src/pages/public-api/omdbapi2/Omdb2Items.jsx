...
import Omdb2ModalView from "./Omdb2ModalView";

const Omdb2Items = ({ item }) => {
  ...
  return (
    <>
      ...
      <Omdb2ModalView itemId={item?.imdbID} modalViewId={modalViewId} onClose={onClose} />
    </>
  );
};
Omdb2Items.propTypes;

export default Omdb2Items;
