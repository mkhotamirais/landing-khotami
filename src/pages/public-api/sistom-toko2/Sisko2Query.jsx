...
import { setCartItems, setQuery, setSearch, setSort } from "../../../redux/features/siskoSlice";
...
const Pilih = ({ id, value, onChange, children }) => {
  return (
    <div>
      <select name={id} id={id} value={value} onChange={onChange} className={`p-1 border rounded`}>
        {children}
      </select>
    </div>
  );
