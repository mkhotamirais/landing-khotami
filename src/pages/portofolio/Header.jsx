...
import { usePorto } from "../../store/usePorto";
...
export const NavContent = ({ onClick, className }) => {
  ...
  useEffect(() => {
    const aboutTop = document.getElementById("about").offsetTop - 360;
    const skillsTop = document.getElementById("skills").offsetTop - 360;
    const projectsTop = document.getElementById("projects").offsetTop - 360;
    const contactTop = document.getElementById("contact").offsetTop - 360;
