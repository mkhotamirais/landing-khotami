        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-6">
          ...
          <div className="flex items-center flex-col gap-8 absolute bottom-12 left-1/2 -translate-x-1/2">
            <div className="flex gap-2">
              <button className="p-4 rounded-full bg-black bg-opacity-10 hover:bg-opacity-40">
                <FaChevronLeft />
              </button>
              <button className="p-4 rounded-full bg-black bg-opacity-10 hover:bg-opacity-40">
                <FaChevronRight />
...
function NavSearch({ className }) {
  return (
    <form onSubmit={(e) => e.preventDefault()} className={`${className} w-full md:w-auto flex`}>
      ...
      />
      <button type="submit" className="w-12 flex items-center justify-center focus:border">
        <FaMagnifyingGlass />
      </button>
    </form>
  );
